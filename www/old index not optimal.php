     ...
     <div class="container">
               ...
               <div class="p-1">
                    <div class="card" style="width: 18rem;">
                         ...
                         <div class="card-body">
                              ...
                              <p class="card-text">Adding and viewing data in the database</p>
                              <a href="/site1" class="btn btn-primary">Example 1</a>
                         </div>
                    </div>
               </div>
               <div class="p-1">
                    <div class="card" style="width: 18rem;">
                         ...
                         <div class="card-body">
                              ...
                              <p class="card-text">Create, Read, Update, Delete operations in the database.</p>
                              <a href="/site2" class="btn btn-primary">Example 2</a>
                         </div>
                    </div>
               </div>
               <div class="p-1">
                    <div class="card" style="width: 18rem;">
                         ...
                         <div class="card-body">
                              ...
                              <a href="/site3" class="btn btn-primary">Example 3</a>
                         </div>
                    </div>
               </div>
          </div>
          <div class="container row">
               <div class="p-1">
                    <div class="card" style="width: 18rem;">
                         ...
                         <div class="card-body">
                              ...
                              <a href="/site4" class="btn btn-primary">Example 4</a>
                         </div>
                    </div>
               </div>
               ...
               <div class="p-1">
                    <div class="card" style="width: 18rem;">
                         <a href="/site5">
                              <img src="img/crud53.png" class="card-img-top p-1" alt="...">
                         </a>
                         <div class="card-body">
                              <h5 class="card-title">+++ Авторизация и регистрация</h5>
                              <p class="card-text">Авторизация регистрация на чистом PHP, пример</p>
